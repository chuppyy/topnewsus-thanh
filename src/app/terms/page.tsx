    ...
    <Container className="py-8">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p>
          ...
          provided on this Application infringes no applicable legal provisions
        ...
        <p>
          ...
          portion of this Application and of its Service without the
        ...
        <div className="bg-gray-100 p-6 rounded-lg mt-8">
          ...
          <div className="space-y-4">
            ...
            <div>
              <h4 className="font-semibold">Owner (or We)</h4>
              <p>
            ...
            <div>
              <h4 className="font-semibold">User (or You)</h4>
              <p>
