      ...
      <div className="prose prose-lg max-w-none">
        <p>
          *This Site is affiliated with Monumetric (dba for The Blogger Network,
          LLC) for the purposes of placing advertising on the Site, and
          Monumetric will collect and use certain data for advertising purposes.
        ...
        <p>
          Your privacy is critically important to us. At Middle Aged Club, we
        ...
        <p>
          Throughout this Privacy Policy we&apos;ll refer to our website as
          &quot;Services.&quot;{" "}
        </p>

        <p>
          Please note that this Privacy Policy does not apply to any of our
          products or services, like our Facebook Group, that have a separate
          privacy policy.
        </p>
        ...
        <ul>
          <li>
            ...
            we require individuals who sign up for a WordPress.com account to
            provide an email address and password, along with a username or name
            — and that&apos;s it. You may provide us with more information —
            like your address and other information you want to share — but we
            don&apos;t require that information to create a WordPress.com
            account.
          </li>

          <li>
            <strong>Public profile information:</strong>&nbsp;If you have an
            account with us, we collect the information that you provide for
            your public profile. For example, if you have a account on our
            website, your username is part of that public profile, along with
            any other information you put into your public profile, like a photo
            or an &quot;About Me&quot; description. Your public profile
            information is just that — public — so please keep that in mind when
          ...
          <li>
            <strong>Communications with us :&nbsp;</strong>You may also provide
            us with information when you communicate with us about a support
            question, post comments in our public forums. When you communicate
            with us via form, email, WordPress.com comment, or otherwise, we
            store a copy of our communications (including any call recordings as
        ...
        <ul>
          <li>
            ...
            website on WordPress.com.
          </li>

          <li>
            <strong>Usage information:</strong>&nbsp;We collect information
            about your usage of our Services. We use this information to, for
          ...
          <li>
            ...
            (like when you post a photograph with location information) if you
          ...
          <li>
            ...
            photographs on your mobile device&apos;s camera roll, our Services
            may access the photos stored on your device when you upload a really
            amazing photograph of the sunrise to your website.
          </li>

          <li>
            <strong>Interactions with other users&apos; sites:</strong>
            &nbsp;We collect some information about your interactions with other
            users&apos; sites while you are logged in to your account with us,
            such as your &quot;Likes&quot; and the fact that you commented on a
            particular post, so that we can, for example,&nbsp;recommend
            posts&nbsp;we think may interest you.{" "}
          </li>
          ...
          <li>
            ...
            provides to the website each time the visitor returns. Pixel tags
            (also called web beacons) are small blocks of code placed on
            websites and emails. We use cookies and other technologies like
            pixel tags to help us identify and track visitors, usage, and access
            preferences for our Services, as well as track and understand email
            campaign effectiveness and to deliver targeted ads. For more
            information about our use of cookies and other technologies for
            tracking, including how you can control the use of cookies, please
        ...
        <ul>
          <li>
            <strong>Third Party Login:</strong>&nbsp;If you create or log in to
            your WordPress.com account through another service (like Google)
            we&apos;ll receive associated login information (e.g. a connection
            token, your username, your email address)
          </li>

          <li>
            <strong>Social Sharing Services:&nbsp;</strong>If you connect our
            website or account to a social media service (like Twitter),
            we&apos;ll receive information from that service (e.g., your
            username, basic profile information, friends list) via the
        ...
        <p>
          ...
          be!). We use this information for marketing purposes like postcards
          and other mailers advertising our Services.
        </p>
        ...
        <ul>
          <li>
            <strong>To provide our Services.</strong>&nbsp;For example, to set
            up and maintain your account, host the website, backup and restore
            your website, provide customer service, process payments and orders,
          ...
          <li>
            ...
            of our Services. Or, for example, by monitoring and analyzing how
            users interact with our Services so we can create new features that
            we think our users will enjoy and that will help them create and
            manage websites more efficiently or make our Services easier to use.
          </li>

          <li>
            <strong>To place and manage ads in our advertising program.</strong>
            &nbsp;For example, to place ads on our users&apos; sites and some of
            our own sites as part of our advertising program, and understand ad
            performance.
          </li>
          ...
          <li>
            ...
            been users for a certain length of time), advertising our Services,
          ...
          <li>
            ...
            protecting the rights and property of Middle Aged Club and others,
            which may result in us, for example, declining a transaction or
            terminating Services.
          </li>

          <li>
            <strong>To fix problems with our Services.</strong>&nbsp;For
          ...
          <li>
            ...
            to personalize your experience by serving you relevant notifications
            and advertisements for our Services, recommending content through
            our Reader post suggestions, and providing new essays and stories
            through Longreads for your reading pleasure.
          </li>

          <li>
            <strong>To communicate with you.</strong>&nbsp;For example, by
            emailing you to ask for your feedback, share tips for getting the
            most out of our products, or keep you up to date on our services;
            texting you to verify your payment; or calling you to share offers
            and promotions that we think will be of interest to you. If you
        ...
        <p>
          ...
          under the applicable terms of service or other agreements with you or
          is necessary to administer your account — for example, in order to
        ...
        <p>
          ...
          example, to provide and update our Services; to improve our Services
        ...
        <p>
          ...
          certain cookies on your device and access and analyze them later on,
        </p>
        ...
        <ul>
          <li>
            <strong>Subsidiaries and independent contractors:</strong>&nbsp;We
          ...
          <li>
            ...
            about you with third-party vendors who need the information in order
            to provide their services to us, or to provide their services to you
            or your site. This includes vendors that help us provide our
            Services to you We require vendors to agree to privacy commitments
          ...
          <li>
            ...
            rights of Middle Aged Club, third parties, or the public at large.
          ...
          <li>
            ...
            merger, sale of company assets, or acquisition of all or a portion
            of our business by another company, or in the unlikely event that
            Middle Aged Club goes out of business or enters bankruptcy, user
            information would likely be one of the assets that is transferred or
            acquired by a third party. If any of these events were to happen,
            this Privacy Policy would continue to apply to your information and
          ...
          <li>
            ...
            service through our Publicize feature.
          </li>

          <li>
            <strong>Aggregated or de-identified information:</strong>&nbsp;We
        ...
        <p>
          ...
          information to data brokers, and we don&apos;t sell your information
          to other companies that want to spam you with marketing emails.
        </p>

        <p>
          We show ads on some of our users&apos; sites as well as some of our
          own, and the revenue they generate lets us offer free access to some
          of our Services so that money doesn&apos;t become an obstacle to
          having a voice.
        </p>

        <p>
          Under a new California law, the California Consumer Privacy Act
          (&quot;CCPA&quot;), some personalized advertising you see online and
          on our services might be considered a &quot;sale&quot; even though we
          don&apos;t share information that identifies you personally, like your
          name or email address, as part of our advertising program.
        </p>
        ...
        <p>
          That means information like your public profile, posts, other content
          that you make public on your website, and your &quot;Likes&quot; and
          comments on other websites are all available to others — and we hope
        ...
        <p>
          ...
          needed for the purposes for which we collect and use it — described in
          the section above on How and Why We Use Information — and we&apos;re
          not legally required to keep it.
        </p>

        <p>
          For example, we keep web server logs that record information about a
          visitor to Middle Aged Club, like the visitor&apos;s IP address,
          browser type, and operating system, for approximately 30 days. We
          retain the logs for this period of time in order to, among other
          things, analyze traffic to Middle Aged Club and investigate issues if
        ...
        <p>
          ...
          Protection Regulation (aka the &quot;GDPR&quot;), you may have certain
          rights regarding your personal information, like the right to request
        ...
        <p>
          ...
          provide California residents with some additional information about
        ...
        <p>
          The CCPA also requires us to provide a list of the
          &quot;categories&quot; of personal information we collect, as that
        ...
        <ul>
          ...
          <li>
            ...
            your usage of our Services, like the actions you take as an
        ...
        <p>
          ...
          CCPA, subject to any exemptions provided by the law, including the
          right to:
        </p>
        ...
        <h4>
          <strong>
            <em>The CCPA &amp; Personalized Advertising in Our Ads Program</em>
          </strong>
        </h4>

        <p>
          Our mission is to democratize publishing and commerce, and that means
          making our Services accessible to as many people as possible. We show
          ads on some of our users&apos; sites as well as some of our own sites,
          and the revenue these ads generate lets us offer free access to some
          of our Services so that money doesn&apos;t become an obstacle to
          having a voice. Our ads program also allows our users to earn revenue
          to support and grow their own sites. As part of our advertising
          program, we and our users do use cookies to share certain device
          identifiers and information about your browsing activities with our
          advertising partners, and those advertising partners may use that
          information to show you personalized ads on some of our users&apos;
          sites and some of our own.
        </p>

        <p>
          The personal information we share includes online identifiers;
          internet or other network or device activity (such as cookie
          information, other device identifiers, and IP address); and
          geolocation data (approximate location information from your IP
          address). These disclosures may be considered a &quot;sale&quot; of
          information under the CCPA. We do not sell (or share) information
          through our ads program that identifies you personally, like your name
          or contact information. We don&apos;t knowingly sell personal
          information of those under 16. Learn how you can opt out by going
          to&nbsp;
          <a href="https://wordpress.com/advertising-program-optout/">
        ...
        <p>
          ...
          your account settings and tools that we offer, but if you aren&apos;t
          able to or you&apos;d like to contact us about one of the other
          rights, go to the Contact form.
        </p>
        ...
        <p>
          ...
          disclose or delete anything. For example, if you are a user, we will
          need you to contact us from the email address associated with your
          account. You can also designate an authorized agent to make a request
          on your behalf by giving us written authorization. We may still
          require you to verify your identity with us.
        </p>
        ...
        <p>
          ...
          and deliver ads that may be more targeted to your interests. Please
          note this Privacy Policy only covers the collection of information by
          our website and does not cover the collection of information by any
          third-party advertisers or analytics providers.
        </p>

        <h4>
          <em>Visitors to Our Users&apos; Websites</em>
        </h4>

        <p>
          We also process information about visitors to our users&apos;
          websites, on behalf of our users and in accordance with our user
          agreements. Please note that our processing of that information on
          behalf of our users for their websites isn&apos;t covered by this
          Privacy Policy. We encourage our users to post a privacy policy that
          accurately describes their practices on data collection, use, and
          sharing of personal information.{" "}
        </p>

        <p>
          Users control the content posted on their sites, so any disputes
          regarding content on a user&apos;s site should be made directly to the
          site owner, through their &quot;contact us&quot; page, at an email
          address they provide, or by leaving a comment on the site.
        </p>

        <h3>Privacy Policy Change</h3>

        <p>
          Although most changes are likely to be minor, Middle Aged Club may
          change its Privacy Policy from time to time. We encourage visitors to
          frequently check this page for any changes to its Privacy Policy. If
          we make changes, we will notify you by revising the change log below,
          and, in some cases, we may provide additional notice. Your further use
          of the Services after a change to our Privacy Policy will be subject
